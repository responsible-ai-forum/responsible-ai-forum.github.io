...
_Due to the different nature of the audience, we prepared two versions of a talk on the same topic. In this post, we summarize the union of their contents in the hope that it will be of interest to our readers. Further, the recording of the first talk (in Czech) can be found below:_
